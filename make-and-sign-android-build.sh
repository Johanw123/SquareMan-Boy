...
jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore "keystoreOuya.der" -storepass vegas123 -keypass vegas123 "android-release-unsigned.apk" johanw123
